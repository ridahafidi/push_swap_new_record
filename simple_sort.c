...
/*   Updated: 2025/03/07 23:38:42 by rhafidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int get_index(t_list *stack, int min_val)
{
    int i;
...
void    get_min_to_top_and_push(t_list **stack_a, t_list **stack_b, int min_index)
{
    int stack_size;
